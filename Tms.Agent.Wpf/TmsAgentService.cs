                ...
                try
                {
                    ...
                    if (!string.IsNullOrEmpty(settings.ApiKey) && !string.IsNullOrEmpty(settings.ServerUrl))
                    {
                        ...
                        if (response != null)
                        {
                            ...
                            if (!string.IsNullOrEmpty(response.CurrentSystemVersion) && response.CurrentSystemVersion != "1.5.31" && response.IsUpgradeAllowed && !string.IsNullOrEmpty(response.SystemBinaryUrl))
                            {
